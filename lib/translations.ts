...
export const translations: Record<LanguageCode, TranslationSchema> = {
  ...
  en: {
    ...
    categories: {
      ...
      cards: [
        ...
        },
        {
          ...
          title: "Pain Management & Analgesics",
          count: "58 Products",
          tag: "NSAIDs & Relief",
        },
        {
        ...
        },
        {
          ...
          title: "Dermatological & Topical Care",
          count: "41 Products",
          tag: "Topical Care",
        },
        {
          category: "Pulmonology",
          title: "Respiratory & Anti-Allergic",
          count: "31 Products",
          tag: "Fast Acting",
        },
        {
          category: "Cardiology",
          title: "Cardiovascular & Lipid Care",
          count: "28 Products",
          tag: "Chronic Care",
        },
        {
          category: "Urology",
          title: "Urology & Nephrology Care",
          count: "18 Products",
          tag: "Targeted Care",
        },
        {
        ...
        },
        {
          ...
          title: "General Therapeutics & Hemostatics",
          count: "14 Products",
          tag: "Essential Care",
        },
        {
        ...
        },
        {
          ...
          title: "Endocrine & Hormonal Therapies",
          count: "3 Products",
          tag: "Hormone Therapy",
        },
        {
          category: "Supportive Care",
          title: "Hematology & Supportive Care",
          count: "1 Product",
          tag: "Blood Health",
        },
      ],
    ...
    contact: {
      ...
      subtitle:
        "Share your product requirements, target market, and preferred dosage forms. Our export team will coordinate product availability, pricing, documentation, and supply requirements.",
    ...
    footer: {
      companyCol: "Quick Links",
      resourcesCol: "Capabilities",
      qualityCol: "Export Desk",
      companyLinks: [
        { label: "About Zelnex", href: "/about" },
        { label: "Finished Formulations", href: "/#products" },
        { label: "Manufacturing Services", href: "/services" },
        { label: "Therapeutic Categories", href: "/#categories" },
        { label: "Knowledge Hub & FAQ", href: "/blogs" },
        { label: "Contact & Inquiries", href: "/contact" },
      ],
      resourceLinks: [
        { label: "Contract Manufacturing (WHO-GMP)", href: "/services#contract" },
        { label: "Third-Party (P2P) Supply", href: "/services#third-party" },
        { label: "Regulatory CTD Dossiers", href: "/services#regulatory" },
        { label: "Generic Formulations Export", href: "/services#generics" },
        { label: "Institutional Tender Supply", href: "/contact" },
      ],
      qualityLinks: [
        { label: "WHO-GMP Validated Facilities", href: "/#certifications" },
        { label: "ISO 9001:2015 Accredited", href: "/#certifications" },
        { label: "CTD & eCTD Dossiers Ready", href: "/services#regulatory" },
      ],
      newsletterTitle: "Global Export Intelligence",
      newsletterDesc:
        "Supporting international pharmaceutical supply through finished formulations, contract manufacturing, regulatory documentation, and export coordination.",
  ...
  es: {
    ...
    categories: {
      ...
      cards: [
        ...
        },
        {
          ...
          title: "Control del Dolor y Analgésicos",
          count: "58 Productos",
          tag: "AINEs y Alivio",
        },
        {
        ...
        },
        {
          ...
          title: "Dermatología y Cuidados Tópicos",
          count: "41 Productos",
          tag: "Cuidado Tópico",
        },
        {
        ...
        },
        {
          ...
          title: "Cardiología y Salud Lipídica",
          count: "28 Productos",
          tag: "Tratamiento Crónico",
        },
        {
          category: "Urología",
          title: "Urología y Nefrología",
          count: "18 Productos",
          tag: "Cuidado Dirigido",
        },
        {
        ...
        },
        {
          ...
          title: "Terapéutica General y Hemostáticos",
          count: "14 Productos",
          tag: "Uso Esencial",
        },
        {
          ...
          count: "11 Productos",
          tag: "Salud Neurológica",
        },
        {
          category: "Cuidado Metabólico",
          title: "Diabetes y Control Metabólico",
          count: "5 Productos",
          tag: "Control Glucémico",
        },
        {
          category: "Endocrinología",
          title: "Terapias Endocrinas y Hormonales",
          count: "3 Productos",
          tag: "Terapia Hormonal",
        },
        {
          category: "Terapia de Soporte",
          title: "Hematología y Cuidados de Apoyo",
          count: "1 Producto",
          tag: "Salud Sanguínea",
        },
      ],
    ...
    footer: {
      companyCol: "Enlaces Rápidos",
      resourcesCol: "Capacidades",
      qualityCol: "Mesa de Exportación",
      companyLinks: [
        { label: "Sobre Zelnex", href: "/about" },
        { label: "Formulaciones Terminadas", href: "/#products" },
        { label: "Servicios Farmacéuticos", href: "/services" },
        { label: "Categorías Terapéuticas", href: "/#categories" },
        { label: "Centro de Conocimiento y FAQ", href: "/blogs" },
        { label: "Contacto y Cotizaciones", href: "/contact" },
      ],
      resourceLinks: [
        { label: "Fabricación por Contrato (OMS-GMP)", href: "/services#contract" },
        { label: "Fabricación para Terceros", href: "/services#third-party" },
        { label: "Dossiers Regulatorios CTD", href: "/services#regulatory" },
        { label: "Exportación de Genéricos", href: "/services#generics" },
        { label: "Suministro Institucional", href: "/contact" },
      ],
      qualityLinks: [
        { label: "Plantas Certificadas OMS-GMP", href: "/#certifications" },
        { label: "Certificación ISO 9001:2015", href: "/#certifications" },
        { label: "Dossiers CTD y eCTD Listos", href: "/services#regulatory" },
      ],
  ...
  pt: {
    ...
    categories: {
      ...
      cards: [
        ...
        },
        {
          ...
          title: "Gestão da Dor e Analgésicos",
          count: "58 Produtos",
          tag: "AINEs e Alívio",
        },
        {
        ...
        },
        {
          ...
          title: "Dermatologia e Cuidados Tópicos",
          count: "41 Produtos",
          tag: "Uso Tópico",
        },
        {
        ...
        },
        {
          ...
          title: "Cardiologia e Controle Lipídico",
          count: "28 Produtos",
          tag: "Cuidado Crônico",
        },
        {
          category: "Urologia",
          title: "Urologia e Nefrologia",
          count: "18 Produtos",
          tag: "Cuidado Direcionado",
        },
        {
          category: "Nutracêuticos",
          title: "Vitaminas, Minerais e Suplementos",
          count: "16 Produtos",
          tag: "Saúde Diária",
        },
        {
          category: "Hospitalar",
          title: "Terapêutica Geral e Hemostáticos",
          count: "14 Produtos",
        ...
        },
        {
          ...
          count: "11 Produtos",
          tag: "Cuidado Neurológico",
        },
        {
          category: "Cuidado Metabólico",
          title: "Diabetes e Controle Metabólico",
          count: "5 Produtos",
          tag: "Controle Glicêmico",
        },
        {
          category: "Endocrinologia",
          title: "Terapias Endócrinas e Hormonais",
          count: "3 Produtos",
          tag: "Terapia Hormonal",
        },
        {
          category: "Cuidado de Suporte",
          title: "Hematologia e Cuidados de Suporte",
          count: "1 Produto",
          tag: "Saúde Sanguínea",
        },
      ],
    ...
    footer: {
      companyCol: "Links Rápidos",
      resourcesCol: "Capacidades",
      qualityCol: "Mesa de Exportação",
      companyLinks: [
        { label: "Sobre a Zelnex", href: "/about" },
        { label: "Formulações Terminadas", href: "/#products" },
        { label: "Serviços Farmacêuticos", href: "/services" },
        { label: "Categorias Terapêuticas", href: "/#categories" },
        { label: "Base de Conhecimento e FAQ", href: "/blogs" },
        { label: "Contato e Cotações", href: "/contact" },
      ],
      resourceLinks: [
        { label: "Fabricação por Contrato (WHO-GMP)", href: "/services#contract" },
        { label: "Fabricação Terceirizada (P2P)", href: "/services#third-party" },
        { label: "Dossiês Regulatórios CTD", href: "/services#regulatory" },
        { label: "Exportação de Genéricos", href: "/services#generics" },
        { label: "Fornecimento Institucional", href: "/contact" },
      ],
      qualityLinks: [
        { label: "Instalações Validadas WHO-GMP", href: "/#certifications" },
        { label: "Certificação ISO 9001:2015", href: "/#certifications" },
        { label: "Dossiês CTD e eCTD Prontos", href: "/services#regulatory" },
      ],
  ...
  fr: {
    ...
    categories: {
      ...
      cards: [
        ...
        },
        {
          ...
          title: "Gestion de la Douleur et Analgésiques",
          count: "58 Produits",
          tag: "AINS et Soulagement",
        },
        {
          category: "Digestif",
        ...
        },
        {
          ...
          title: "Dermatologie et Soins Topiques",
          count: "41 Produits",
          tag: "Usage Cutané",
        },
        {
        ...
        },
        {
          ...
          title: "Cardiologie et Soins Lipidiques",
          count: "28 Produits",
          tag: "Maladies Chroniques",
        },
        {
          category: "Urologie",
          title: "Urologie et Néphrologie",
          count: "18 Produits",
          tag: "Soins Ciblés",
        },
        {
          category: "Nutraceutiques",
          title: "Vitamines, Minéraux et Compléments",
          count: "16 Produits",
          tag: "Santé Quotidienne",
        },
        {
          category: "Hospitalier",
          title: "Thérapeutique Générale et Hémostatiques",
          count: "14 Produits",
          tag: "Soins Essentiels",
        },
        {
          category: "Neurologie",
        ...
        {
          category: "Soins Métaboliques",
          title: "Diabète et Soins Métaboliques",
          count: "5 Produits",
          tag: "Contrôle Glycémique",
        },
        {
          category: "Endocrinologie",
          title: "Thérapies Endocriniennes et Hormonales",
          count: "3 Produits",
          tag: "Hormonothérapie",
        },
        {
          category: "Soins de Support",
          title: "Hématologie et Soins de Support",
          count: "1 Produit",
          tag: "Santé Sanguine",
        },
      ],
    ...
    footer: {
      companyCol: "Liens Rapides",
      resourcesCol: "Capacités",
      qualityCol: "Pôle Export",
      companyLinks: [
        { label: "À Propos de Zelnex", href: "/about" },
        { label: "Formulations Finies", href: "/#products" },
        { label: "Services Pharmaceutiques", href: "/services" },
        { label: "Catégories Thérapeutiques", href: "/#categories" },
        { label: "Base de Connaissances et FAQ", href: "/blogs" },
        { label: "Contact et Devis", href: "/contact" },
      ],
      resourceLinks: [
        { label: "Fabrication à Façon (OMS-GMP)", href: "/services#contract" },
        { label: "Fabrication pour Tiers (P2P)", href: "/services#third-party" },
        { label: "Dossiers Réglementaires CTD", href: "/services#regulatory" },
        { label: "Exportation de Génériques", href: "/services#generics" },
        { label: "Approvisionnement Institutionnel", href: "/contact" },
      ],
      qualityLinks: [
        { label: "Installations Validées OMS-GMP", href: "/#certifications" },
        { label: "Certification ISO 9001:2015", href: "/#certifications" },
        { label: "Dossiers CTD et eCTD Prêts", href: "/services#regulatory" },
      ],
