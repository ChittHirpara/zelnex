...
export function ContactInfoCards() {
  ...
  const contactDetails = [
    ...
    },
    {
      ...
      mainText: "contact@zelnexpharma.com",
      subText: "export@zelnexpharma.com · regulatory@zelnexpharma.com",
      telemetry: "Average response: < 4 hours",
      actionText: "Send Direct Email",
      actionHref: "mailto:contact@zelnexpharma.com",
      copyText: "contact@zelnexpharma.com",
    },
    {
      id: "hours",
