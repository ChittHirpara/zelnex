        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-white/15">
          <div className="flex items-center gap-3">
            <Link href="/" className="relative block">
              <Image
                src="/brand/zelnex-white-logo.svg"
              ...
              <div>
                ...
                <div className="flex flex-col gap-3 text-xs sm:text-[13px] text-white/90 font-sans">
                  ...
                  >
                    ...
                    <span className="truncate">info@zelnexpharmaceuticals.com</span>
                  </a>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-cyan-100/80 font-sans">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white border border-white/20 transition-all duration-300 hover:scale-110 hover:bg-white hover:text-[#0A66C2] hover:shadow-[0_0_14px_rgba(255,255,255,0.7)] cursor-pointer"
                aria-label="LinkedIn"
                title="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white border border-white/20 transition-all duration-300 hover:scale-110 hover:bg-white hover:text-black hover:shadow-[0_0_14px_rgba(255,255,255,0.7)] cursor-pointer"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white border border-white/20 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:text-white hover:shadow-[0_0_14px_rgba(255,255,255,0.7)] cursor-pointer"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white border border-white/20 transition-all duration-300 hover:scale-110 hover:bg-white hover:text-[#1877F2] hover:shadow-[0_0_14px_rgba(255,255,255,0.7)] cursor-pointer"
                aria-label="Facebook"
                title="Facebook"
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white border border-white/20 transition-all duration-300 hover:scale-110 hover:bg-white hover:text-[#EA4335] hover:shadow-[0_0_14px_rgba(255,255,255,0.7)] cursor-pointer"
              ...
              <a
                ...
                aria-label="Email: info@zelnexpharmaceuticals.com"
                title="Email Us"
              >
