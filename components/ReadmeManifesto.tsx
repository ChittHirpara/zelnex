        ...
        <div className="bg-[#0d1117] border border-slate-700 rounded-xl overflow-hidden shadow-2xl text-slate-300 font-['JetBrains_Mono',monospace]">
          ...
          <div className="p-6 sm:p-10 space-y-6 text-xs sm:text-[13px] leading-relaxed">
            ...
            <p className="text-slate-300">
              Zelnex operates as an export-oriented pharmaceutical powerhouse based in Surat, Gujarat, India. We architect high-potency finished generic formulations and maintain comprehensive Common Technical Document (CTD) and eCTD files for Ministry of Health registration across 10+ global nations.
            </p>
